<template>
  <div class="bg-background-tertiary relative">
    <div class="container-inner mx-auto py-8 sm:py-16 pb-12 text-center">
      <h2 class="text-2xl font-bold mb-4">Contact</h2>
      <div class="text-lg sm:text-xl mb-12">
        <br />Write us at
        <a href="mailto:hello@luseeds.com">
          hello
          <span class="hidden">antispam?</span>@
          <span class="hidden">dunnoletstry</span>luseeds.com
        </a>
        <br />Or you can reach us at
        <a href="https://github.com/luseeds" target="_black" rel="noopener">
          <svg
            width="20"
            height="20"
            fill="currentColor"
    ...
    <RectangleDots
      class="container-inner mx-auto absolute bottom-0 left-0 right-0 pb-4 pointer-events-none"
    />
  </div>
</template>
<script>
import RectangleDots from "~/../content/assets/rectangle-dots.svg"
export default {
  components: {
    RectangleDots
  }
