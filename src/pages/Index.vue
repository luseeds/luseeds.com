  ...
  <Layout>
    <section class="hero">
      <div class="py-16 relative">
        <div
          class="container-inner mx-auto text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left relative z-10 p-8 bg-white"
        >
    ...
    <section-delimiter
      title="Mission"
      color="green-400"
      unpurgecss="text-green-400 bg-green-400"
    />
    <div class="container-inner mx-auto mt-12">
      <div class="text-lg sm:text-xl text-justify">
        The mission of Luseeds is to develop a collection of impactful projects
        that all have in common strong core values. Environment, sustainability,
        radicality, honesty, freedom, ethics are some of them. Each project is
        considered as a seed of knowledge whose goal is to make you discover and
    ...
    <div class="overflow-x-hidden">
      ...
      >
        <h2 class="font-bold mb-6" id="projects">
          Here are some projects we've developped:
        </h2>
    ...
    <div class="newsletter bg-background-tertiary">
      <div class="container-inner mx-auto py-16 pb-8 text-center textl-xl">
        <h2 class="text-2xl font-bold mb-8">More text</h2>
      ...
      <div class="container-inner mx-auto -mt-32 pb-4 overflow-x-hidden">
        <g-image
          src="../../content/assets/rectangle-dots.svg"
          alt="rectangle dots"
        />
      </div>
    </div>
